...
namespace OnlinePhotoManager.Web.Controllers
{
    ...
    public class PicturesController : Controller
    {
        ...
        public PicturesController(IAlbumRepository albums, IPictureRepository pictures, IUserRepository user)
        {
        ...
        public ActionResult AddNewPicture(Picture picture, HttpPostedFileBase image)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Album","Albums", new {albumName});
            }
            return View(picture);
        }
        ...
        public ActionResult EditPicture(Picture picture, HttpPostedFileBase image)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToRoute("PictureScheme",
                    new
                    {
                        action = "Index",
                        controller = "Pictures",
